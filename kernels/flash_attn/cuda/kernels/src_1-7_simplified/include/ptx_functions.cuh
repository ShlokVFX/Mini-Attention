...
// ---------------------------------------------------------------------------
// ldmatrix: load matrix tiles from smem into registers
// ---------------------------------------------------------------------------

// Non-transposed: loads (16×16) chunk as 4 × 8-element rows into a1..a4
template <typename T>
...
// Transposed: loads (16×16) chunk with column-major ordering (used for V)
template <typename T>
...
// ---------------------------------------------------------------------------
// mma.sync.m16n8k16: warp-level matrix multiply-accumulate
//   D = A * B + C   (f16/bf16 inputs, f32 accumulator)
//   A: 16×16, B: 8×16, C/D: 16×8
// ---------------------------------------------------------------------------
